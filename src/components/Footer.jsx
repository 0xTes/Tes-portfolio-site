  ...
  return (
    <footer className="mt-16 bg-slate-950 px-6 py-16 text-slate-300 md:py-20">
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-12 border-b border-white/10 pb-12 sm:grid-cols-2 xl:grid-cols-[minmax(0,1.4fr)_minmax(0,0.72fr)_minmax(0,0.95fr)_minmax(0,0.85fr)_minmax(0,0.95fr)] xl:gap-8 xl:pb-16">
          <div className="min-w-0 sm:col-span-2 lg:col-span-1">
            <a
              href="/"
              className="inline-block max-w-[250px] rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-300"
            >
              <img src={horizontalLogo} alt="Teslim Digital" className="h-auto w-full" />
            </a>
          ...
          <nav aria-label="Footer legal navigation" className="min-w-0">
            <p className="text-sm font-semibold uppercase tracking-[0.16em] text-teal-300">
              Legal
            </p>
            <ul className="mt-5 space-y-3 text-[1.0625rem]">
          ...
          <div className="min-w-0 xl:self-end xl:text-right">
            <a
              href={STORE_URL}
              target="_blank"
